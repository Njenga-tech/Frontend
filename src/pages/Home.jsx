...
import CategoryCard from "../Components/categoryCard"; // Ensure the filename is exactly 'CategoryCard.jsx'
...
export default function Home() {
  ...
  return (
    <div className="max-w-8xl mx-auto mt-7 px-1">
      {/* Carousel Section */}
      <Carousel
        autoPlay
        infiniteLoop
      ...
      >
        ...
        <div className="relative h-[80vh]">
          ...
          <div className="absolute inset-0  bg-opacity-50 flex items-center justify-start px-8">
            <div className="text-left max-w-xl">
              <h2 className="text-3xl md:text-5xl text-blue-900 font-bold mb-4">
        ...
        <div className="relative h-[80vh]">
          ...
          <div className="absolute inset-0  bg-opacity-50 flex items-center justify-start px-8">
            <div className="text-left max-w-xl">
              <h2 className="text-5xl md:text-5xl text-blue-300 font-bold mb-4">
